 ...
 *L=T[0];
 ...
 void search (string repas,Record *L)
{
    printf("\n\n");
    Record *T;
    T=L;
...
//20/10/2022	16H-18H		Douala		Yaounde		bonne		0	16	M	3000
//21/11/2021	10H-12H		Rivertale	Konoha		mauvaise	1	28	F	10000
